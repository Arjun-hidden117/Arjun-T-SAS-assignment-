...
disp('As the number of terms increases, the Fourier series approximation becomes closer to the 
original triangular wave.'); 
disp('Since the triangular wave is continuous and has a finite slope, the Fourier series converges 
faster compared to the square wave.');
